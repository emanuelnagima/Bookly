  ...
  import { useEffect } from "react"; // Importe aqui
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Cadastro para alunos, professores e usuários especiais."
    },
    {
      icon: <FaRegCalendarCheck className="fa-reg-calendar-check" />,
      title: "Sistema de Reservas",
      description: "Operação para reserva de livros e conversão automática em empréstimos."
    },
    {
      icon: <FaExchangeAlt className="fa-exchange-alt" />,
      title: "Empréstimos",
      description: "Controle de empréstimos por usuário e verificação de disponibilidade de livros."
    },
    {
  ...
  export default function About() {
    // Adicione este useEffect para alterar o título da página
    useEffect(() => {
      document.title = "Bookly - Sobre";
    }, []);
